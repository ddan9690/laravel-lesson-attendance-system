    ...
    <div class="p-3 md:p-6">
        ...
        <div class="flex flex-wrap gap-3 mb-4">
            ...
            <a href="{{ route('classAttendance') }}"
                class="bg-purple-600 text-white px-3 py-1 md:px-4 md:py-2 rounded-lg shadow hover:bg-purple-700 font-semibold text-sm md:text-base">
        ...
        <div x-data="attendanceFilter()"
            class="flex flex-wrap gap-2 mb-5 items-end text-sm md:text-base bg-white shadow rounded-lg p-3">
            <!-- From Date -->
            <div>
                    ...
                    <tbody>
                        @foreach ($lessonAttendanceSummary as $index => $summary)
                            <tr class="border-b even:bg-green-50 hover:bg-green-100">
                                ...
                                <td class="px-2 py-1 font-medium whitespace-nowrap">{{ $summary['teacher']->name ?? 'N/A' }}
                                </td>
                                ...
                                <td class="px-2 py-1 text-center font-semibold whitespace-nowrap">{{ $summary['total'] }}
                                </td>
