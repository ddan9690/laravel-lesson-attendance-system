...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('teacher')->group(function () {
        ...
        Route::post('change-password/store', [TeacherController::class, 'updatePassword'])
    ...
    Route::prefix('dashboard')->group(function () {
        ...
        Route::get('admin', [DashboardController::class, 'admin'])
            ...
            ->middleware('role:super_admin|principal|deputy|dos|senior_teacher');

        Route::get('committee', [DashboardController::class, 'committee'])
            ->name('dashboard.committee')
            ->middleware('role:committee_member');

        Route::get('class_supervisor', [DashboardController::class, 'classSupervisor'])
            ->name('dashboard.class_supervisor')
            ->middleware('role:class_supervisor');

        Route::get('class_teacher', [DashboardController::class, 'classTeacher'])
            ->name('dashboard.class_teacher')
            ->middleware('role:class_teacher');
